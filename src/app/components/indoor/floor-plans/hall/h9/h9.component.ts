...
export class H9FloorPlanComponent implements OnInit {
  ...
  public initNav(name: string) {
    ...
    if (name.includes('h9')) {
      ...
      point = this.interestPoints.filter(point => point.id === 'h9-wc-female')[0];
    } else if (name.includes('male')) {
      point = this.interestPoints.filter(point => point.id === 'h9-wc-male')[0];
    } else if (name.includes('ne')) {
      point = this.interestPoints.filter(point => point.id === 'h9-stairs-ne')[0];
    } else if (name.includes('nw')) {
      point = this.interestPoints.filter(point => point.id === 'h9-stairs-nw')[0];
    } else if (name.includes('sw')) {
      point = this.interestPoints.filter(point => point.id === 'h9-stairs-sw')[0];
    } else if (name.includes('se')) {
      point = this.interestPoints.filter(point => point.id === 'h9-stairs-se')[0];
    } else if (name.includes('escalator-down')) {
      point = this.interestPoints.filter(point => point.id === 'h9-escalator-down')[0];
    } else if (name.includes('escalator-up')) {
      point = this.interestPoints.filter(point => point.id === 'h9-escalator-up')[0];
    }
