...
@Component({
  selector: 'vl1-floor-plan',
  templateUrl: 'vl1.component.html',
  styleUrls: ['./vl1.component.scss']
})
export class Vl1FloorPlanComponent {
  constructor(private events: Events) {}

  ngAfterViewInit() {
    //indoo-map.component is subscribe to it
    //when html of floor is loaded, the map may be set with new information
    this.events.publish('floor-loaded', {building: 'vanier', floor: '1'}, Date.now());
  }
