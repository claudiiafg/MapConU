/*
  THIS PAGE IS ONLY FOR DEV PURPOSES
  IN ORDER TO BE ABLE TO HAVE ALL INFORMATION AVAILABLE IN THE WEB AND FACILITATE THE DEVELOPMENT

  SINCE THE SQLITE IS SETUP AS CORDOVA PLUGIN, AND THE DEVELOPMENT WOULD REQUIRE BUILDING IOS/ANDROID EVERYTIME CHANGE DONE IN CODE

  PLEASE DONT DELETE UNTIL END OF PROJECT
  THANKS
*/
...
export const externalOverlayCoords = [
  {
    name: 'Hall Building',
  ...
  { name: 'Faubourg Ste Catherine Building', coords: fgCoords },
  {
    name: 'EV Building',
  ...
  { name: 'Grey Nuns', address: '1190 Guy St.', coords: gnCoords },
  {
    name: 'Concordia Annexes',
    address: '2010-2110 Mackay St.',
    coords: annexCoords
  },
  { name: 'TD Building', address: '1410 Guy St.', coords: tdCoords },
  {
